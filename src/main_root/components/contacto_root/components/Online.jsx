...
function gradientMouse (event) {
  ...
  const online = document.getElementById("online2");
    ...
    let mouseXpercentage = Math.round(event.changedTouches[0].pageX / windowWidth * 100);
    let mouseYpercentage = Math.round(event.changedTouches[0].pageY / windowHeight * 100);
...
export default function Online() {
  return (
    <div id="online2" className="online" onTouchMove={gradientMouse}>
      <ul className="prueba">
        <li className="prueba2"><i className="icon3-whatsapp"></i></li>
        <li className="prueba2"><i className="icon3-phone2"></i></li>
        <li className="prueba2"><i className="icon3-gmail"></i></li>
      </ul>
      <ul className="prueba">
